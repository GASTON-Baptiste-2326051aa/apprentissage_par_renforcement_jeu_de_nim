...
from charts import load_stats,bars_hypothese1,bars_hypothese2,bars_hypothese3,bars_hypothese4
...
def hypothese1():
    ...
    game(2000,20,sheetname="20 allumettes", writer=writer1, writer_reduced=writer_reduced1)
    game(2000,29,sheetname="29 allumettes", writer=writer1, writer_reduced=writer_reduced1)
...
def hypothese2():
    ...
    game(2000,11,6,6,sheetname="Punition et récompense = 6",writer=writer2, writer_reduced=writer_reduced2)
...
def hypothese3():    
    ...
    game(2000,11,sheetname="IA n°2 commence",writer=writer3, writer_reduced=writer_reduced3,first_player = "Machine 2")
